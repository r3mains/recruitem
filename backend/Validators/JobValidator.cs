...
public class JobUpdateValidator : AbstractValidator<JobUpdateDto>
{
  ...
  {
    RuleFor(x => x).Must(x => x.Title != null || x.Description != null || x.JobTypeId.HasValue || x.LocationId.HasValue || x.SalaryMin.HasValue || x.SalaryMax.HasValue || x.PositionId.HasValue || x.StatusId.HasValue || x.ClosedReason != null)
